# Kickstart for provisioning a RHEL 7.1 Azure HPC VM
...
# System services
services --enabled="sshd,waagent,ntpd,dnsmasq,NetworkManager"
...
# Enable RDMA driver
  ...
  rm -f /initramfs-3.10.0-229.el7.x86_64.img 2>/dev/null
  rm -f /boot/initramfs-3.10.0-229.el7.x86_64.img 2>/dev/null
  echo -e "\nexclude=kernel*\n" >> /etc/yum.conf
...
curl -so /tmp/${MPI}.tgz http://olcentwus.cloudapp.net/openlogic/${MPI}.tgz  ## Internal link to MPI package
