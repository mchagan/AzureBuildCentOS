# Kickstart for provisioning a RHEL 6.8 Azure HPC VM
...
repo --name="CentOS-Updates" --baseurl=-url --url=http://olcentgbl.trafficmanager.net/centos/6.8/updates/x86_64/

# Root password
rootpw --plaintext "to_be_disabled"

# System services
services --enabled="sshd,waagent,ntpd,dnsmasq,hypervkpd"
