# Kickstart for provisioning a CentOS 6.9 Azure VM
...
url --url=http://olcentgbl.trafficmanager.net/centos/6.9/os/x86_64/
...
# Add OpenLogic repo
repo --name=openlogic --baseurl=http://olcentwe.cloudapp.net/openlogic/6/openlogic/x86_64/
